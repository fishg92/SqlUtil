CREATE TABLE [dbo].[ClevelandLongQueries]
(
...
GO
ALTER TABLE [dbo].[ClevelandLongQueries] ADD CONSTRAINT [PK__Clevelan__AAAC09D83C69FB99] PRIMARY KEY CLUSTERED  ([RowNumber]) ON [PRIMARY]
GO
